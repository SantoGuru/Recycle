          ...
          <table className="w-full max-w-5xl min-w-[300px] mt-5 drop-shadow-xl mx-auto border-separate border-spacing-0 rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="p-3 text-left font-semibold text-gray-700">Unidade</th>
                <th className="p-3 text-left font-semibold text-gray-700">Ações</th>
              </tr>
            </thead>
            <tbody>
              {materials.length > 0 ? (
                materials.map((material, index) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-gray-800">{material.descricao}</td>
                ...
                <tr>
                  <td colSpan="4" className="p-3 text-center text-gray-500 bg-white">
